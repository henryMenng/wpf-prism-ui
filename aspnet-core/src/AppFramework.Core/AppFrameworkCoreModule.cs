...
namespace AppFramework
{
    ...
    public class AppFrameworkCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            AppFrameworkLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, AppFrameworkMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<AppFrameworkSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
