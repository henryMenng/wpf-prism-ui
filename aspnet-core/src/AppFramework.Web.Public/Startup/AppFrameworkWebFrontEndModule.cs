...
{
    [DependsOn(
        typeof(AppFrameworkWebCoreModule)
    )]
    public class AppFrameworkWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AppFrameworkWebFrontEndModule(IWebHostEnvironment env, AppFrameworkEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AppFrameworkWebFrontEndModule).GetAssembly());
        }
    }
}
