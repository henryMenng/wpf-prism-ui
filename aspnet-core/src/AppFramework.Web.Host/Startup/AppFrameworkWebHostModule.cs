...
namespace AppFramework.Web.Startup
{
    ...
    public class AppFrameworkWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AppFrameworkWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AppFrameworkWebHostModule).GetAssembly());
        }
