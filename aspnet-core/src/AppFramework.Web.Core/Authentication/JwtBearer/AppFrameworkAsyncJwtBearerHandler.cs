...
{
    public class AppFrameworkAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public AppFrameworkAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
