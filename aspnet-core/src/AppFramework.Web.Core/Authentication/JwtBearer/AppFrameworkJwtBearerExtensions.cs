...
/// </summary>
public static class AppFrameworkJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, AppFrameworkAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
