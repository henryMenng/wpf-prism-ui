...
import { AppFrameworkDemoCommonModule } from '@shared/common/common.module';
...
function initializeLocalForage() {
    localForage.config({
        ...
        name: 'AppFrameworkDemo',
        version: 1.0,
        storeName: 'abpzerotemplate_local_storage',
        description: 'Cached data for AppFrameworkDemo',
    });
}
...
@NgModule({
    imports: [
        ...
        AppModule,
        AppFrameworkDemoCommonModule.forRoot(),
        ServiceProxyModule,
        HttpClientModule,
        RootRoutingModule,
        NgxSpinnerModule,
